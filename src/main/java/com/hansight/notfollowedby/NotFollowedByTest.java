        ...
        Pattern<ObjectNode, ObjectNode> pattern = Pattern.<ObjectNode>
                ...
                .where(new IterativeCondition<ObjectNode>() {
                    ...
                    public boolean filter(ObjectNode node, Context<ObjectNode> ctx) throws Exception {
                        ...
                        return expr && ExpressionUtil.equal(nodeA, "src_address", node, "src_address") && ExpressionUtil.equal(nodeA, "dst_address", node, "dst_address") && ExpressionUtil.equal(nodeA, "src_port", node, "src_port") && ExpressionUtil.equal(nodeA, "dst_port", node, "dst_port");
                    }
                })
